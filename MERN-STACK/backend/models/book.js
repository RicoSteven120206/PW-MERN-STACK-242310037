...
module.exports = (sequelize, DataTypes) => {
  class Book extends Model {
    static associate(models) {
      // definisikan relasi di sini jika ada (misal: User, Category, dll)
    }
  }
  ...
  Book.init(
    {
      ...
      sinopsis: {
        ...
        allowNull: false,
        validate: {
          notEmpty: { msg: 'Sinopsis cannot be empty' },
          len: {
            args: [10, 1000],
      ...
      story: {
        ...
        allowNull: false,
        validate: {
          notEmpty: { msg: 'Story cannot be empty' },
          len: {
            args: [10],
    ...
    },
    {
      ...
      updatedAt: 'updated_at' // FIXED: Harus 'updatedAt' (camelCase)
    }
  );
